 ...
 */
public class RadialMenuOptionsBuilder2 implements Builder<RadialMenuOptions> {
    private HashMap<String, Property> properties = new HashMap<String, Property>();


    // ******************** Constructors **************************************
    protected RadialMenuOptionsBuilder2() {}


    // ******************** Methods *******************************************
    public static final RadialMenuOptionsBuilder2 create() {
        return new RadialMenuOptionsBuilder2();
    }

    public final RadialMenuOptionsBuilder2 degrees(final double DEGREES) {
        properties.put("degrees", new SimpleDoubleProperty(DEGREES));
        return this;
    }

    public final RadialMenuOptionsBuilder2 offset(final double OFFSET) {
        properties.put("offset", new SimpleDoubleProperty(OFFSET));
        return this;
    }

    public final RadialMenuOptionsBuilder2 radius(final double RADIUS) {
        properties.put("radius", new SimpleDoubleProperty(RADIUS));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonSize(final double BUTTON_SIZE) {
        properties.put("buttonSize", new SimpleDoubleProperty(BUTTON_SIZE));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonFillColor(final Color BUTTON_INNER_COLOR) {
        properties.put("buttonFillColor", new SimpleObjectProperty<Color>(BUTTON_INNER_COLOR));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonStrokeColor(final Color BUTTON_FRAME_COLOR) {
        properties.put("buttonStrokeColor", new SimpleObjectProperty<Color>(BUTTON_FRAME_COLOR));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonForegroundColor(final Color BUTTON_FOREGROUND_COLOR) {
        properties.put("buttonForegroundColor", new SimpleObjectProperty<Color>(BUTTON_FOREGROUND_COLOR));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonAlpha(final double BUTTON_ALPHA) {
        properties.put("buttonAlpha", new SimpleDoubleProperty(BUTTON_ALPHA));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonHideOnSelect(final boolean BUTTON_HIDE_ON_SELECT) {
        properties.put("buttonHideOnSelect", new SimpleBooleanProperty(BUTTON_HIDE_ON_SELECT));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonHideOnClose(final boolean BUTTON_HIDE_ON_CLOSE) {
        properties.put("buttonHideOnClose", new SimpleBooleanProperty(BUTTON_HIDE_ON_CLOSE));
        return this;
    }

    public final RadialMenuOptionsBuilder2 tooltipsEnabled(final boolean TOOLTIPS_ENABLED) {
        properties.put("tooltipsEnabled", new SimpleBooleanProperty(TOOLTIPS_ENABLED));
        return this;
    }

    public final RadialMenuOptionsBuilder2 buttonVisible(final boolean BUTTON_VISIBLE) {
        properties.put("buttonVisible", new SimpleBooleanProperty(BUTTON_VISIBLE));
        return this;
    }

    public final RadialMenuOptionsBuilder2 simpleMode(final boolean SIMPLE_MODE) {
        properties.put("simpleMode", new SimpleBooleanProperty(SIMPLE_MODE));
        return this;
    }

    public final RadialMenuOptionsBuilder2 strokeVisible(final boolean STROKE_VISIBLE) {
